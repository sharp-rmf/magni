...
key_mapping = {
    'q': [ 0.5,  1], 'w': [ 0,  1], 'e': [-0.5,  1],
    'a': [ 1,  0], 's': [ 0,  0], 'd': [-1,  0], 
    'z': [ 0.5, -1], 'x': [ 0, -1], 'c': [-0.5, -1] }
...
g_vel_ramps = [2, 2] # units: meters per second^2
...
if __name__ == '__main__':
  ...
  g_vel_scales[1] = fetch_param('~linear_scale', 0.2)
  g_vel_ramps[0] = fetch_param('~angular_accel', 50.0)
  g_vel_ramps[1] = fetch_param('~linear_accel', 50.0)
